        ...
        <section className="w-full py-[40px] xl:py-[70px] flex justify-center items-center">
            ...
            <div className={`w-full ${styles.containerWidth}`}>
                <div className="w-full flex flex-col gap-8 justify-center items-center">
                    ...
                    <p className="font-[600] text-[16px] text-[#C99237]">Our Commitment</p>
                        <h2 className="font-[400] text-[36px] max-w-[675px]"><span className="font-[700]">Innovating</span> for Tomorrow with
                    ...
                    <div className="w-full flex justify-between gap-4">
                        ...
                        <div className="w-[392px] h-[456px] rounded-[5px] border-[1px] border-[#D7D7D7] flex flex-col justify-between items-start p-10">
                            <p className="font-[400] text-[16px]">Where visuals driving tangible actions are a daily reality, we deliver meaningful results through foresight and innovation. Believing that everything can be achieved via never-ending evolution.</p>

                            <div className="flex flex-col gap-3">
                                <img src="/new-about-imgs/s7/bulb.png" alt="Ritz Media World" title="Ritz Media World" className="w-[82px] h-auto" />
                                <p className="font-[500] text-[36px]">Our Vision</p>
                            </div>
                        </div>
                        ...
                        <div className="w-[392px] h-[456px] rounded-[5px] bg-[#0F1640] flex flex-col justify-between items-start p-10">
                            <p className="font-[400] text-[16px] text-white">Every strategy we put together unlocks fresh opportunities. As a forward thinker, our aim is to create the future today. Every project we deliver leaves a mark and has real impact and consequence.</p>

                            <div className="flex flex-col gap-3">
                                <img src="/new-about-imgs/s7/arrow.png" alt="Ritz Media World" title="Ritz Media World" className="w-[98px] h-auto" />
                                <p className="font-[500] text-[21px] text-white">Crafting Strategies, Shaping the Future, & Driving Impact</p>
                            </div>
                        </div>
                    </div>
                </div>
