            ...
            <div className="flex flex-col gap-3 sm:gap-4 md:gap-0 lg:gap-3 xl:gap-6 w-full max-w-[100%] md:max-w-[80%] lg:max-w-none">
                <div className="w-[200px]  h-[28px] sm:h-[32px] md:h-[30px] lg:h-[37px] relative hidden md:block">
                    <Image
                        ...
                        priority
                    />
                    <p className={`font-[700] text-center md:text-left text-[12px] sm:text-[13px] md:text-[14px] lg:text-[16px] text-white absolute top-[50%] uppercase -translate-y-1/2 right-4 sm:right-5 md:right-22 lg:right-20 ${styles.fontmontserrat}`}>
                    About
                    </p>
                </div>
                <div className="pl-0 flex flex-col gap-2 md:pl-9 lg:pl-10 xl:pl-12 pb-[58px] md:pb-[15px] lg:pb-0">
                    ...
                    About <span className="font-[400]">Us</span>
                    </h1>
                    ...
                    Driving Success with Every Brand <br className="hidden md:block" /> Strategy We Create and Deliver.
