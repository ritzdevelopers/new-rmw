...
function Section4() {
    return (
        <section className="w-full py-[70px] flex justify-center items-center">
            ...
            <div className={`w-full flex flex-col-reverse lg:flex-row  justify-between items-center lg:items-stretch lg:gap-4 gap-12 ${styles.containerWidth}`}>
                {/* Left Side Container  */}
                <div className="xl:w-[603px] xl:h-[566px] lg:w-[500px] lg:h-[480px] shrink-0 relative w-full h-[615px]">
                    <Image src={'/slug/s3/seo-s3-img1.jpg'} fill alt="SEO"></Image>
                </div>

                {/* Right Side Container — stretches to row height (matches tallest sibling) */}
                <div className="flex min-h-0 flex-1 flex-col items-start justify-between self-stretch lg:max-w-[593px] w-full gap-4 lg:gap-0">
                    {/* Row 1  */}
                    <div>
                        <h2 className={`font-[700] xl:text-[36px] text-[23px]  ${styles.fontmontserrat}`}>We’re Award-Winning Development Agencies</h2>
                        <p className={`font-[400] xl:text-[16px] text-[14px]  ${styles.fontpoppins}`}>
                    ...
                    {/* Row 2  */}
                    <div className="flex justify-between lg:gap-2 gap-8">
                        <div>  <img src="/services-v3-slug/s4/17_plus.png" alt="" className="xl:w-[429px] w-[300px] h-auto" /></div>
                    ...
                    <div className="w-full flex flex-col gap-4 justify-between">
                        <ul className={`font-[400] text-[14px] list-none md:list-disc pl-4 flex flex-col gap-2 xl:gap-3  text-center md:text-left mb-4 md:mb-0 [&>li::marker]:text-[20px] ${styles.fontpoppins}`}>
