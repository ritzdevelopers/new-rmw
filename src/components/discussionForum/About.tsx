            ...
            <div className="w-[100%] md:w-[100%] lg:w-[100%] xl:w-[74%] text-center mx-auto px-4 md:px-[40px] lg:px-[50px] min-[1370px]:!w-[1300px] min-[1370px]:!max-w-[1300px] min-[1370px]:mx-auto">
                ...
                >
                    <span className="font-bold">Discussion Forum by</span> <span className="text-[#C99237] font-bold">Ritz Media World </span><span className="font-normal">
                        a space where ideas meet strategy and conversations turn into growth.
                    </span>
                </p>

                <div
                    className={`${styles.fontopensans} lg:mt-6 text-[#2d2d2d] text-[12px] sm:text-[14px] md:text-[16px] leading-[23px] md:leading-[25px] lg:text-[16px] w-full max-w-[849px] mx-auto text-center`}
                >
                    <p>
                        Whether you're looking for a SEO company in Noida, a social media marketing agency, or the best digital marketing company in Delhi, this forum is your place to ask questions, share insights, and explore the future of advertising and digital marketing.
