            ...
            <div className={`w-full px-4 pb-6 md:hidden ${styles.s5Mobile}`}>
                <div className="w-full flex flex-col gap-5 text-center">
                    ...
                    <div className="w-full flex flex-col gap-3 pt-4 items-center">
                        <img src="/service-v3/content-marketing/s5/17-yow2.png" alt="17 Years of Working" className="w-full max-w-[240px] h-auto object-contain" />
                ...
                <div className="w-full flex flex-col md:flex-row gap-6 sm:gap-8 md:gap-0">
                    ...
                    <div className="px-8 w-[30%] xl:w-[calc(100%-831px)] h-auto xl:h-[430px] relative flex flex-col justify-end xl:justify-between ">
                        ...
                        <div className="flex flex-col w-full ">
                            ...
                            <img src="/service-v3/content-marketing/s5/17-yow2.png" alt="Why Content Marketing Matters" className="w-[275px] xl:w-full  h-auto object-cover" />

                            {/* Google Reviews Image  */}
                            <img src="/service-v3/content-marketing/s5/google-reviews.png" alt="Why Content Marketing Matters" className="w-[275px] xl:w-[271px]  h-auto object-cover" />
                        </div>
