...
function Section6({imgPath = "/service-v3/print-advertising/s7/s7-graphics.png"} : {imgPath?: string}) {
    return (
        <section className="w-full flex justify-center items-center border-b border-t border-[#E6E3E3] pt-6 sm:pt-8 md:pt-10 lg:pt-[35px] xl:py-[70px]">
            ...
            <div className={`w-full flex flex-col items-center sm:items-start xl:items-end sm:h-[542px] lg:h-auto sm:flex-row justify-between gap-2 lg:gap-4 ${styles.containerWidth}`}>
                {/* Left Side Container  */}
                ...
                <div className="w-full sm:w-[40%] lg:w-auto flex flex-col xl:items-end md:flex-row justify-between items-center gap-6 xl:gap-8 min-w-0">
