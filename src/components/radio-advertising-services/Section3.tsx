        ...
        <section className="w-full flex justify-center  lg:pt-[30px]">
            ...
            >
                ...
                <div className="w-[80%] xl:w-[798px] xl:flex-shrink-0 relative px-0">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 w-full md:w-[calc(100%-2rem)] min-w-0 md:max-w-[450px]  -top-10 py-3 px-3 sm:py-4 sm:px-4 bg-[#F7F7F7] rounded-[4px]">
                        <div className="w-full min-h-0 shrink-0">
                            <p className="font-[500] text-[11px] md:text-[16px] xl:text-[20px] text-center">
