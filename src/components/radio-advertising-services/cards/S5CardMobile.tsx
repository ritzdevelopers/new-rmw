...
function S5CardMobile({ title, image, content, index }: S5CardMobileProps) {
    ...
    return (
        <article className="w-full flex-shrink-0 flex flex-col bg-white rounded-xl overflow-hidden border border-[#E8E8E8] shadow-sm">
            <div className="relative w-full h-[250px] bg-[#F2F2F2] flex items-center justify-center p-3">
            ...
            <div className="flex flex-col gap-3 p-4">
                ...
                <p className={`font-[400] text-[14px] leading-relaxed text-[#444] line-clamp-4 ${styles.fontopensans}`}>
                    {content}
                </p>
