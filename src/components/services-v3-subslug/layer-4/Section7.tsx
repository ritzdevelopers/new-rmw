      ...
      <div className="w-[92%] sm:w-[90%] md:w-[86%] lg:w-[80%] mx-auto flex flex-col gap-6">
        ...
        <div className="w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
          <div className="text-center md:text-left">
            ...
            <h2
              className="font-[700] text-[24px] sm:text-[28px] lg:text-[36px] text-white"
            ...
            {awardsData.map((ob, idx) => (
              <SwiperSlide key={idx} style={{ height: "auto" }}>
                <div className="w-full max-w-[401px] mx-auto xl:pl-[10px]">
                  <div className="w-full h-[250px] sm:h-[280px] lg:h-[326px] border border-[#C9923780] relative flex justify-center items-center">
                    ...
                    <div className="w-[110px] sm:w-[120px] lg:w-[125px] h-[32px] sm:h-[34px] lg:h-[36px] rounded-[50px] bg-[#ffffff] text-[#F59612] flex justify-center items-center gap-1 absolute top-2 -left-2 sm:-left-2.5 lg:-left-3 z-10">
                      <img
                        src="/home-v3/s7/star2.png"
                        alt=""
                        className="w-[20px] sm:w-[22px] lg:w-[24px] h-[20px] sm:h-[22px] lg:h-[24px]"
                      />
                      <p
                        className="font-[600] text-[12px] sm:text-[13px] lg:text-[14px]"
                        style={{ fontFamily: "OpenSansSemiBold" }}
                      >
                        {ob.highlite}
                      </p>
                  ...
                  <div className="w-full min-h-[51px] bg-[#C992372E] text-white p-3 sm:p-3.5 lg:p-4">
                    <p
                      className="font-[400] text-[13px] sm:text-[14px] lg:text-[15px]"
