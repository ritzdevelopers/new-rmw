        ...
        <section className="w-full flex justify-center items-center border-b border-t border-[#E6E3E3] py-6 sm:py-8 md:py-10 lg:py-[35px] xl:py-[70px]">
            ...
            <div className={`w-full flex flex-col items-center sm:items-start sm:h-auto lg:h-auto sm:flex-row justify-between gap-6 sm:gap-4 lg:gap-4 ${styles.containerWidth}`}>
                ...
                <div className="w-full sm:w-[56%] lg:w-[475px] xl:w-[594px] flex flex-col gap-4 sm:gap-10 lg:gap-12 xl:gap-6 flex-shrink-0 min-w-0">
                    ...
                    {/* Bottom Container  */}
                    <div className="w-full flex flex-col gap-4 sm:gap-5 lg:gap-2">
                        {/* Row 1  */}
                        <div className="w-full flex flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
                            <h3 className={`font-[500] text-[16px] sm:text-[20px] md:text-[24px] xl:text-[28px] leading-tight ${styles.fontmontserrat}`}>A Skilled <span className="font-[700]">Creative Team Delivering</span> Solutions That Drive <span className="font-[700]">Brand Growth</span></h3>
                        ...
                        <div className="w-full min-w-0">
                            <img src="/service-v3/print-advertising/s7/s7-group-img.png" alt="" className="w-full h-auto object-contain" />
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full sm:w-[40%] lg:w-auto flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6 xl:gap-8 min-w-0">
                    ...
                    <div className="flex-col    hidden lg:flex justify-center items-center text-center w-full lg:w-auto order-2 lg:order-1 flex-shrink-0">
                        <div className="relative w-full h-[673px] sm:w-[260px] sm:h-[515px] lg:w-[230px] lg:h-[554px] xl:w-[299px] xl:h-[591px] mx-auto flex-shrink-0 overflow-hidden">
                            <Image src="/service-v3/layer1/charts/mobile-frame-img.png" alt="" fill className="object-contain z-10" sizes="(max-width: 640px) 240px, (max-width: 1024px) 280px, 299px" />
                        ...
                        <div className="w-full flex flex-col gap-3">
                            ...
                            <div className="flex w-full justify-between gap-4">
                                <div className="flex flex-col gap-0 lg:gap-2">
                                    <h3 className={`font-[700] text-[28px] sm:text-[32px] xl:text-[37px] ${styles.fontmontserrat}`}>1B+</h3>
                                    <p className={`font-[600] text-[11px] sm:text-[12px] md:text-[14px] ${styles.fontopensans}`}>Creatives Published</p>
                                </div>
                                <div className="flex flex-col gap-0 lg:gap-2">
                                    <h3 className={`font-[700] text-[28px] sm:text-[32px] xl:text-[37px] ${styles.fontmontserrat}`}>500+</h3>
                                    <p className={`font-[600] text-[11px] sm:text-[12px] md:text-[14px] ${styles.fontopensans}`}>Success Stories</p>
                                </div>
                            </div>
                        </div>
                        {/* Row 2  */}
