...
function    FormComponent() {
    ...
    const handleBrandAuditDownload = async (e: React.FormEvent) => {
        e.preventDefault();
            ...
            <div className={`w-full flex flex-col justify-center items-center gap-8 xl:gap-18 ${styles.containerWidth}`}>
                ...
                <div className={`w-full flex flex-col lg:flex-row justify-between gap-6 `}>
                    ...
                    <div className="w-full lg:w-[48%] xl:w-[603px]  bg-[#F7F7F7] flex flex-col justify-around px-4 lg:px-8 py-6 sm:py-7 lg:py-8 md:px-6">
                        ...
                        <ul
                            className="font-[400] text-[13px] md:text-[14px] lg:text-[13px] xl:text-[16px] text-[#000000] list-disc pl-4 flex flex-col gap-2 sm:gap-3 text-left mb-5 xl:mb-5"
                            style={{
                                fontFamily: "PoppinsRegular",
                            }}
                        >
                    ...
                    <div className="w-full lg:w-[48%] xl:w-[603px]  border-1 border-[#D4D4D4] lg:bg-[url('/home-v3/s8/s8img.png')] bg-cover bg-center px-6 sm:px-7 lg:px-8 py-6 sm:py-7 lg:py-8 flex flex-col gap-3 sm:gap-4">
                        ...
                        <ul
                            className="list-disc pl-4 flex flex-col gap-2 sm:gap-3 font-[400] text-[13px] md:text-[15px] lg:text-[13px] xl:text-[16px] text-[#00000] text-left"
                            style={{
                                fontFamily: "PoppinsRegular",
                            }}
                        >
