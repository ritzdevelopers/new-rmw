...
function Section1() {
    return (
        <section className='w-full h-[460px] md:min-h-[500px] lg:min-h-[615px] bg-[url("/home-v3/service-imgs/s1/rmw-service-banner3.jpg")] bg-cover bg-no-repeat bg-center flex md:items-end pb-8 sm:pb-12 md:pb-16 lg:pb-20 xl:pb-26 px-4 sm:px-6 md:px-8 lg:px-0
