...
function Section5() {
    ...
    return (
        <section className="w-full flex justify-center items-center  ">
            ...
            <div className={`w-full flex flex-col justify-center items-center gap-6 sm:gap-8 lg:gap-10 xl:gap-12 ${styles.containerWidth}`}>

                {/* Top Container  */}
                <div className="w-full flex flex-col text-center justify-center items-center gap-2   px-4 sm:px-0">
                ...
                <div className="w-full flex flex-col gap-3 sm:gap-4 xl:gap-5">
                    ...
                    <div className="flex flex-col lg:flex-row w-full justify-between gap-3 sm:gap-4 xl:gap-5">
                        ...
                        <div className="flex flex-col justify-between gap-3 sm:gap-4 xl:gap-5 w-full lg:w-[397px] xl:w-[430px] h-auto sm:h-[250px] md:h-[280px] lg:h-[319px] xl:h-[350px] bg-[#0F1640] py-4 sm:py-5 lg:py-4 xl:py-5 px-4 sm:px-5 lg:px-6 xl:px-7">
                            {/* Top Row  */}
                            <div>
                                <p className={`font-[400] text-[14px] sm:text-[15px] lg:text-[16px] xl:text-[17px] text-white ${styles.fontopensans}`}>Facts & Numbers</p>
                            </div>

                            {/* Bottom Row  */}
                            <div>
                                <h3 className={`font-[600] text-[50px] sm:text-[60px] md:text-[70px] lg:text-[80px] xl:text-[90px] text-white leading-none ${styles.fontopensans}`}>89<span className="text-[30px] sm:text-[38px] md:text-[45px] lg:text-[50px] xl:text-[55px]">%</span></h3>
                                <p className={`font-[400] text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px]   text-white leading-tight sm:leading-normal mt-2 sm:mt-3 xl:mt-4 ${styles.fontopensans}`}>to customers recommend <br />
                    ...
                    {/* Row 2  */}
                    <div className="flex flex-col lg:flex-row w-full justify-between gap-3 sm:gap-4 xl:gap-5">
                        <div className="w-full lg:w-[35%] xl:w-[430px] h-auto sm:h-[280px] lg:h-[319px] xl:h-[350px] flex flex-col justify-between gap-3 sm:gap-4 xl:gap-5 bg-[#FFF2DD] py-4 sm:py-5 lg:py-4 xl:py-5 px-4 sm:px-5 lg:px-6 xl:px-7">
                            {/* Row 1  */}
                            <div className="flex w-full justify-between gap-2 sm:gap-4 xl:gap-5">
                                <div className="flex flex-col gap-1 sm:gap-2 xl:gap-3">
                                    <p className={`font-[500] text-[32px] sm:text-[40px] md:text-[45px] lg:text-[50px] xl:text-[55px] leading-none ${styles.fontmontserrat}`}>1B+</p>
                        ...
                        <div className="w-full  lg:w-[63%] xl:max-w-[900px] h-auto  lg:h-[319px] xl:h-[350px] relative bg-[#F7F7F7] flex flex-col justify-between gap-3 sm:gap-4 xl:gap-5 py-4 sm:py-5 lg:py-4 xl:py-5 px-4 sm:px-5 lg:px-6 xl:px-7">
                            {/* Top Static Row  */}
