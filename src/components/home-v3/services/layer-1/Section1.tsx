        ...
        bg-cover bg-no-repeat bg-center flex items-center md:items-end pb-8 sm:pb-4 lg:pb-22
         xl:pb-20 px-0`}>
            <div className="flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6 w-full max-w-[100%] md:max-w-[80%] lg:max-w-none">
                <div className="w-[200px]  h-[28px] sm:h-[32px] md:h-[35px] lg:h-[37px] relative hidden lg:block">
                    <Image
                        ...
                        priority
                    />
                    <p className={`font-[700] text-center md:text-left text-[12px] sm:text-[13px] md:text-[14px] lg:text-[16px] text-white absolute top-[50%] uppercase -translate-y-1/2 right-4 sm:right-5 md:right-6 lg:right-8 ${styles.fontmontserrat}`}>
                       Services
                    </p>
                </div>
                <div className="pl-0 flex flex-col gap-2 md:pl-9 lg:pl-10 xl:pl-12 pb-[58px] lg:pb-0">

                    <h1 className={`font-[800] text-center md:text-left text-[26px] sm:text-[36px] md:text-[31px] lg:text-[55px] text-white leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-14 mt-1 sm:mt-2 md:mt-3 ${styles.fontmontserrat}`}>
                       Digital Marketing
                    </h1>
