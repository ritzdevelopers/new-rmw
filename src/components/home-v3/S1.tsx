      ...
      <div className="w-full max-w-[600px] flex flex-col gap-12 sm:gap-16 lg:gap-20 mt-0 sm:mt-12 lg:mt-20">
        ...
        <div className="font-[500] text-[12px] sm:text-[13px] lg:text-[14px] flex flex-col gap-4 sm:gap-5 lg:gap-6 md:mt-0 mt-10">
          <div>
            ...
            <h1 className="font-[800] text-[28px] sm:text-[36px] md:text-[42px] lg:text-[52px] leading-tight sm:leading-tight lg:leading-normal" style={{
                fontFamily: 'MontserratExtraBold',
            }}>
                <span className="text-[#C99237]" style={{
                    fontFamily: 'MontserratExtraBold',
                }}>Beyond</span> your typical Advertising agency
            </h1>
          </div>
