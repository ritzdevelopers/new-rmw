                      ...
                      >
                        <SwiperSlide>
                          <div className="tp-testimonial__item">
                            ...
                            <div className="tp-testimonial__content">
                              <p>
                                To me, advertising my brand was merely a means
                                to ensure my elongated presence in the market.
                                Thanks to ritz Media world, my advertisements
                                not only ensured my brand’s sustenance but have
                                also got me a great number of quality leads.
                              </p>
                        ...
                        <SwiperSlide>
                          <div className="tp-testimonial__item">
                            ...
                            <div className="tp-testimonial__content">
                              <p>
                                If there is one thing serving as a full service
                                digital agency for more than a decade taught us,
                                it has to be the value of relationships.
                                Therefore, our relationship with our clients is
                                both a priority and a point of pride to us.{" "}
                              </p>
                              <div className="tp-testimonial__author">
                                <h3 className="tp-testimonial__author-title">
                                  FAIRFOX - EON
                        ...
                        <SwiperSlide>
                          <div className="tp-testimonial__item">
                            ...
                            <div className="tp-testimonial__content">
                              <p>
                                I must admit that RMW and its team of
                                professionals are always on my favourite list.
                                They have always delivered the best services to
                                me even if they had to put in extra efforts and
                                their team has always been available for
                                extensive support.
                              </p>
                              <div className="tp-testimonial__author">
                                <h3 className="tp-testimonial__author-title">
