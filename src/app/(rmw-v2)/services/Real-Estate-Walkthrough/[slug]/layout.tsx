...
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
    ...
    if (!serviceData) {
        return {
            alternates: {
                canonical: `https://ritzmediaworld.com/services/real-estate-walkthrough/${slug}`,
            },
        };
    }
    ...
    return {
        ...
        alternates: {
            canonical: getCanonicalUrl(serviceData.link, `/services/real-estate-walkthrough/${slug}`),
        },
    };
}
