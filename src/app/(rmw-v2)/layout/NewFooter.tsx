...
function NewFooter() {
  return (
    <footer className="w-full bg-[#0F1640] flex flex-col lg:flex-row lg:items-stretch">
      {/* Left Side Container  */}
      <div className="w-full lg:w-[321px] bg-[#0C123A] flex justify-center items-center py-8 sm:py-12 lg:py-[72px] px-6 sm:px-8 lg:px-12 lg:self-stretch">
      ...
      <div className="w-full lg:w-[calc(100%-321px)] bg-[#0F1640] flex justify-center items-center py-8 sm:py-12 lg:py-[72px] px-4 sm:px-6 lg:px-8 xl:px-12 lg:self-stretch flex-1">
        ...
        <div className="flex flex-col gap-6 sm:gap-8 w-full max-w-[1200px]">
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 lg:gap-16 xl:gap-24">
                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                    ...
                    <ul className="text-white text-[13px] sm:text-[14px] lg:text-[15px] font-[400] flex flex-col gap-2.5 sm:gap-3 lg:gap-4 list-disc">
                        ...
                        <li className="ml-4">Web Stories</li>
                        <li className="ml-4">Contact</li>
                        <li className="ml-4">Career</li>
                    </ul>
                </div>
                {/* Col 2  */}
                <div className="flex flex-col gap-3 sm:gap-4">
                    ...
                    <ul className="text-white text-[13px] sm:text-[14px] lg:text-[15px] font-[400] flex flex-col gap-2.5 sm:gap-3 lg:gap-4 list-disc">
                        <li className="ml-4">Digital Marketing</li>
                        <li className="ml-4">Print Advertising</li>
                        <li className="ml-4">Radio Advertising</li>
                        <li className="ml-4">Creative Services</li>
                        <li className="ml-4">Content Marketing</li>
                        <li className="ml-4">Web Development</li>
                        <li className="ml-4">Celebrity Endorsements</li>
                        <li className="ml-4">Influencer Marketing</li>
                    </ul>
                </div>
                ...
                <div className="flex flex-col gap-4 sm:gap-6">
                   ...
                   <div className="flex gap-2 sm:gap-3 flex-wrap">
                    <div className="flex w-[36px] h-[36px] sm:w-[40px] sm:h-[40px] rounded-[5px] flex justify-center items-center text-white bg-[#17205E] hover:bg-[#C99237] active:bg-[#C99237] transition-colors duration-300 cursor-pointer">
            ...
            <div className="flex flex-col gap-4 sm:gap-6 pt-3 sm:pt-4 border-t border-[#17205E]">
                 ...
                 <div className="mb-1 sm:mb-2">
                    <img src="/home-v3/colab-img.png" alt="parteners and collaborators" className="" />
                 </div>
