...
function NewFooter() {
  return (
    <footer className="w-full bg-[#0F1640] flex flex-col lg:flex-row lg:items-stretch">
      {/* Left Side Container  */}
      <div className="w-full lg:w-[321px] bg-[#0C123A] flex justify-center lg:justify-start py-8 sm:py-12 lg:py-[72px] xl:py-0 px-6 sm:px-8 lg:px-12 lg:self-stretch">
        {/* Centered Align Container  */}
        <div className="flex flex-col gap-6 sm:gap-8 w-full max-w-[321px] mt-0 lg:mt-[62px] px-4 items-center lg:items-start text-center lg:text-left">
          {/* Row 1  */}
          <div className="flex flex-col gap-4 sm:gap-6">
            {/* Logo Container  */}
            <div className="mb-1 sm:mb-2">
              <img src="/home-v3/rmw-f-logo.png" alt="ritz media world logo" className="w-auto h-auto max-w-[200px] sm:max-w-none mx-auto lg:mx-0" />
            </div>
            {/* Address Container  */}
      ...
      <div className="w-full lg:w-[calc(100%-321px)] bg-[#0F1640] flex justify-center items-center py-8 sm:py-12 lg:py-[72px] xl:py-[52px] px-4 sm:px-6 lg:px-8 xl:px-12 lg:self-stretch flex-1">
        ...
        <div className="flex flex-col gap-6 sm:gap-8 w-full max-w-[1200px]">
            ...
            <div className="flex flex-col sm:flex-row gap-0 items-start">
                ...
                {/* Col 3  */}
                <div className="w-full flex flex-col gap-4 sm:gap-6 items-start">
                   {/* Google Review Image  */}
                   <div className="mb-1 sm:mb-2">
                    <img src="/home-v3/clients/reviews.png" alt="google review" className="w-full max-w-[200px] sm:max-w-[250px] lg:max-w-none mx-auto lg:mx-0" />
                   </div>
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
                 ...
                 <div className="mb-1 sm:mb-2 flex flex-wrap justify-start items-center gap-4 sm:gap-6 lg:gap-10 h-auto lg:h-[79px] w-full overflow-x-auto lg:overflow-visible">
                 ...
                 {/* Copy Right Text  */}
                 <div>
                    <p className="text-white text-[13px] sm:text-[14px] lg:text-[15px] font-[400] text-left">© 2026 <span className="font-[700]">
