...
function NewS2() {
  return (
    <section className="w-screen flex flex-col gap-8 sm:gap-8 md:gap-0 lg:gap-12 items-center min-h-[60vh] py-8 sm:py-10 md:py-14 px-4 sm:px-6">
      ...
      <div className="flex flex-col justify-center gap-4 sm:gap-5 md:gap-6 items-center w-full md:w-[85%] lg:w-[65%]">
        <div className="text-center">
          <h2 className="font-[500] text-[24px] sm:text-[28px] md:text-[32px] lg:text-[36px] leading-tight sm:leading-snug">
