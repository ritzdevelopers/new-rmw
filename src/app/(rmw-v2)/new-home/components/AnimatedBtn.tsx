...
function AnimatedBtn({ btnText, link = "" }: { btnText: string, link?: string }) {
  return (
    <div onClick={() => window.open(link, "_blank")} className={`w-[62px] h-[62px] rounded-full text-white flex items-center justify-center cursor-pointer bg-[#242424] ${styles.animatedBtn}`}>
