...
import { Swiper as SwiperClass } from "swiper"; // 👈 Swiper type for useRef
...
export default function SwiperSlider({ dt }: DATAARR) {
  ...
  return (
    <div style={bodyStyle}>
      ...
      >
        {dt &&
          dt.map((ob: DATA, index: number) => (
            <SwiperSlide key={index} style={cardStyle}>
              <div
                style={{
                  width: "100%",
                  height: "100%",
      ...
      <div style={btnWrapperStyle}>
        <div style={btnGroupStyle}>
          ...
          <button style={btnNextStyle} onClick={handleNext}>
            {/* Right Arrow */}
            <svg width="32" height="24" viewBox="0 0 32 24" fill="none">
              <path
