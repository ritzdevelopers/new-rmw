...
function page() {
  ...
  const contentData = [
    ...
    },
    {
      ...
      menuCategory: "Marketing Campaign",
      status: false,
    },
    {
      menuImg: "https://picsum.photos/seed/4/300/200",
      menuCategory: "Video Production",
      status: true,
    },
    {
    ...
    },
    {
      ...
      menuCategory: "Lead Generation",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/17/300/200",
      menuCategory: "E-commerce Setup",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/18/300/200",
      menuCategory: "Media Buying",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/19/300/200",
      menuCategory: "Voice Over",
      status: false,
    },
    {
      menuImg: "https://picsum.photos/seed/20/300/200",
      menuCategory: "Script Writing",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/21/300/200",
      menuCategory: "Corporate Branding",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/22/300/200",
      menuCategory: "Reputation Management",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/23/300/200",
      menuCategory: "WhatsApp Marketing",
      status: false,
    },
    {
      menuImg: "https://picsum.photos/seed/24/300/200",
      menuCategory: "Search Engine Optimization",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/25/300/200",
      menuCategory: "Content Strategy",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/26/300/200",
      menuCategory: "Product Photography",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/27/300/200",
      menuCategory: "YouTube Promotions",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/28/300/200",
      menuCategory: "Google Ads",
      status: false,
    },
    {
      menuImg: "https://picsum.photos/seed/29/300/200",
      menuCategory: "Snapchat Campaigns",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/30/300/200",
      menuCategory: "Interactive Design",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/31/300/200",
      menuCategory: "Brochure Design",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/32/300/200",
      menuCategory: "Flyer Design",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/33/300/200",
      menuCategory: "Reels Editing",
      status: false,
    },
    {
      menuImg: "https://picsum.photos/seed/34/300/200",
      menuCategory: "Custom Illustrations",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/35/300/200",
      menuCategory: "2D Animation",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/36/300/200",
      menuCategory: "3D Modelling",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/37/300/200",
      menuCategory: "Business Presentation",
      status: false,
    },
    {
      menuImg: "https://picsum.photos/seed/38/300/200",
      menuCategory: "Client Testimonials Video",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/39/300/200",
      menuCategory: "Explainer Videos",
      status: true,
    },
    {
      menuImg: "https://picsum.photos/seed/40/300/200",
      menuCategory: "Campaign Strategy",
      status: true,
    },
  ];
