...
export default function ServiceSecondPage() {
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-cyan-50 p-6 md:p-10">
      <div className="mx-auto max-w-5xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
        ...
        <p className="mt-3 text-slate-600">
          Basic page is ready. You can add Service Second management actions
          here.
        </p>
      </div>
    </section>
